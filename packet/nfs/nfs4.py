...
class COMPOUND4args(NFSbase):
    ...
    """
    # Class attributes
    _strfmt2  = "COMPOUND4 tag={0!r}, minorversion={1}, array={2}"
...
class COMPOUND4res(NFSbase):
    ...
    """
    # Class attributes
    _strfmt2  = "COMPOUND4 status={0}, tag={1!r}, array={2}"
...
class CB_COMPOUND4args(NFSbase):
    ...
    """
    # Class attributes
    _strfmt2  = "CB_COMPOUND4 tag={0!r}, minorversion={1}, callback_ident={2:#010x}, array={3}"
...
class CB_COMPOUND4res(NFSbase):
    ...
    """
    # Class attributes
    _strfmt2  = "CB_COMPOUND4 status={0}, tag={1!r}, array={2}"
    _attrlist = ("status", "tag", "array")
