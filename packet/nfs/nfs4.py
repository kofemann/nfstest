...
#===============================================================================
# Generated by process_xdr.py from nfs4.x on Fri Aug 21 21:53:09 2015
...
class layoutreturn_file4(BaseObj):
    ...
    _attrlist = ("offset", "length", "stateid", "body")
...
SECINFO_NO_NAME4args = secinfo_style4
...
class ALLOCATE4args(BaseObj):
    ...
    """
    # Class attributes
    _strfmt1  = "stid:{0} off:{1:umax64} len:{2:umax64}"
...
class COPY4args(BaseObj):
    ...
    """
    # Class attributes
    _strfmt1  = "src:(stid:{0} off:{2:umax64}) dst:(stid:{1} off:{3:umax64}) len:{4:umax64}"
...
class IO_ADVISE4args(BaseObj):
    ...
    """
    # Class attributes
    _strfmt1  = "stid:{0} off:{1:umax64} len:{2:umax64} hints:{3}"
...
class LAYOUTERROR4args(BaseObj):
    ...
    """
    # Class attributes
    _strfmt1  = "off:{0:umax64} len:{1:umax64} stid:{2} {3}"
...
class READ_PLUS4args(BaseObj):
    ...
    """
    # Class attributes
    _strfmt1  = "stid:{0} off:{1:umax64} len:{2:umax32}"
    _attrlist = ("stateid", "offset", "count")
...
class SEEK4args(BaseObj):
    ...
    """
    # Class attributes
    _strfmt1  = "stid:{0} off:{1:umax64} {2}"
